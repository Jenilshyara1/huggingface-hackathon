...
class FinopsEnv(
    ...
    """
    Client for the Finops Env Environment.
    ...
    Example:
        ...
        ...
        ...     result = client.step(FinopsAction(message="Hello!"))
        ...     print(result.observation.echoed_message)

    Example with Docker:
        >>> # Automatically start container and connect
        >>> client = FinopsEnv.from_docker_image("finops_env-env:latest")
        >>> try:
        ...     result = client.reset()
        ...     result = client.step(FinopsAction(message="Test"))
        ... finally:
        ...     client.close()
    """
